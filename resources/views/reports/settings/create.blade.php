...
@section('content')
    <div class="container-fluid">
        ...
        <div class="col-md-4 mb-25">
            <input id="cost" type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="10% برجاء ادخال النسبة" name="cost[]" >
        </div>
        <div class="col-md-4 mb-25">
             <input id="salary" type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="برجاء ادخال القيمة" name="salary[]" >
         </div>
        `;
