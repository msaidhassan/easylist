                        ...
                        <div class="userDatatable adv-table-table global-shadow border-0 bg-white w-100 adv-table">
                            <div class="table-responsive">
                                <div class="adv-table-table__header">
                                    <h4>{{ trans('menu.affiliate_marketers') }}</h4>
                                ...
                                <table class="table mb-0 table-borderless adv-table" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                    ...
                                    <tr>
                                        <td>اسم المسوق :
                                            <a href="#">
                                                ...
                                                {{ $clientsAtrs->previousClient->name}}
                                            </a></td>
                                    ...
                                    <tr class="userDatatable-header">
                                        ...
                                        <th>
                                            <span class="userDatatable-title"> مستحقاته </span>
                                        </th>
                                    @php
                                    $total = 0;
                                    @endphp
                                    ...
                                    @foreach($orders as $order)
                                        ...
                                        @php
                                            $total +=$order->clientValue;
                                        @endphp
                                    @endforeach
                                    <tr>

                                        <td>الإجمالي لكل طلباته : {{ $total }}</td>
                                    </tr>
                                    </tbody>
                                </table>
