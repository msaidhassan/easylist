                            ...
                            <table class="table mb-0 table-borderless adv-table" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                <thead>
                                    <tr class="userDatatable-header">
                                        ...
                                        <th>
                                            <span class="userDatatable-title">  النسية  </span>
                                        </th>
                                        <th>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                                <div class="d-flex">
                                                    <div class="userDatatable-inline-title">
                                                        <a href="{{route('salesOfficer.order.details',[app()->getLocale(),$salesOfficer['id'],$inventory->id])}}" class="text-dark fw-500">
                                                        <h6>{{$salesOfficer['name']}}</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                             ...
                                             <td>
                                                ...
                                                <h6>{{number_format($salesOfficer['total'],2)}}</h6>
                                                </div>
                                            </td>
                                    ...
                                    @endforeach
                                    <tr>
                                        <td> مستحقاتة : {{ $totalSalesOfficerValue }}</td>
                                    </tr>
