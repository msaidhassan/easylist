                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table mb-0 table-borderless adv-table" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                                <div class="d-flex">
                                                    <div class="userDatatable-inline-title">
                                                        <a href="{{route('salesAgent.order.details',[app()->getLocale(),$salesAgent['id'],$inventory->id])}}" class="text-dark fw-500">
                                                        <h6>{{$salesAgent['name']}}</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    @endforeach
                                    <tr>
                                            <td>مستحقاتة  : {{ $totalSalesAgentValue }}</td>
                                    </tr>
