                            ...
                            <table class="table mb-0 table-borderless adv-table" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                <thead>
                                    <tr class="userDatatable-header">
                                        ...
                                        <th>
                                            <span class="userDatatable-title">  إجمالي الميزانية</span>
                                        </th>

                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($valueOfSetting as $setting)
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <td>
                                                ...
                                                <h6>{{number_format($setting['total'] ,2)}}</h6>
                                                </div>
                                            </td>
                                ...
                                <tr>
                                    <td>الإجمالي </td>
                                    <td>:</td>
                                    <td>{{ number_format($totalSettingValue,2)}}</td>
                                </tr>
                                </tbody>
                            </table>
