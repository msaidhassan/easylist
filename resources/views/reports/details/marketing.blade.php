                            ...
                            <table class="table mb-0 table-borderless adv-table" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                <thead>
                                    <tr class="userDatatable-header">
                                        ...
                                        <th>
                                            <span class="userDatatable-title"> العميل الأساسي </span>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title"> عدد العملاء المسندين إليه  </span>
                                        </th>
                                        <th>
                                ...
                                <tbody>
                                    @foreach ($ClientsAttr as $order )
                                    <tr>

                                        <td>
                                                <div class="d-flex">
                                                    <div class="userDatatable-inline-title">
                                                        <a href="{{route('marketing.order.details',[app()->getLocale(),$order['id'],$inventory->id])}}" class="text-dark fw-500">
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div class="userDatatable-inline-title">
                                                        <a href="{{route('all_previous_client',[app()->getLocale(),$order['previousClientId']])}}" class="text-dark fw-500">

                                                           <h6>{{$order['numberOfClients']}}</h6>
                                                        </a>
