                ...
                <form action="{{route('store_user' , app()->getLocale())}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-25">
                            <input type="text" name="username" required class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="اللقب" value="{{ old('username') }}">
                        ...
                        <div class="col-md-6 mb-25">
                            <input type="text" name="name" required class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="الاسم" value="{{ old('name') }}">
                            @if ($errors->has('name'))
                                <span class="text-danger">{{ $errors->first('name') }}</span>
                            @endif
                        </div>
                        <div class="col-md-6 mb-25">
                            <input type="text" name="email" required class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="البريد الإلكتروني" value="{{ old('email') }}">
                            @if ($errors->has('email'))
                                <span class="text-danger">{{ $errors->first('email') }}</span>
                            @endif
                        </div>
                        <div class="col-md-6 mb-25">
                            <input type="password" name="password" required class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="كلمة السر">
                            @if ($errors->has('password'))
                                <span class="text-danger">{{ $errors->first('password') }}</span>
                            @endif
                        </div>
                        <div class="col-md-6 mb-25">
                            <select name="role" id="countryOption898" required class="try form-control px-15" onchange="toggleManagerSection()">
                        ...
                        <div class="col-md-6 mb-25">
                            <input type="text" name="phone" required class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="رقم الموبايل" value="{{ old('phone') }}">
                            @if ($errors->has('phone'))
                        ...
                        <div class="col-md-6 mb-25">
                            <input type="text" name="wphone" required class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="واتساب" value="{{ old('wphone') }}">
                        ...
                        <div class="col-md-6 mb-25">
                            <input type="text" name="card" required class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="الرقم القومي" value="{{ old('card') }}">
                            @if ($errors->has('card'))
