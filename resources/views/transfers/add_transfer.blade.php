                ...
                <div class="card-body py-md-30">
                    ...
                    <form action="{{route('store_transfer' , app()->getLocale())}}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-25">
                                <input type="text" required name="value" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="قيمة الحوالة الإجمالية" value="">
                            </div>
                        ...
                        <div class="dm-select">
                            ...
                            <select name="method" id="select-alerts333333" required class="form-control">
                                <option value=""></option>
                            ...
                            <div class="col-md-4 mb-25">
                                <input type="text" name="proof" required class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="إثبات التحويل" value="">
                            </div>
                            ...
                            <div class="col-md-4 mb-25">
                                ...
                                <div class="dm-select">
                                    ...
                                    <select name="officer" id="select-alerts33" required class="form-control ">
                                        <option value=""></option>
                            ...
                            <div class="col-md-4 mb-25">
                                ...
                                <div class="dm-select">
                                    ...
                                    <select name="agent" id="select-alerts22" required class="form-control ">
                                        <option value=""></option>
