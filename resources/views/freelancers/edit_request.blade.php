        ...
        <div class="col-lg-12">
            <div class="card card-Vertical card-default card-md mb-4">
                ...
                <div class="card-body py-md-30">
                    ...
                    <form action="{{route('update_request_freelancer' , [app()->getLocale() , $request_freelancer->id])}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-25">
                                <div class="form-group select-px-15 text-end">
                                    ...
                                    <select class="form-control px-15 text-end" id="mainField" name="main_field_id" required>
                                        ...
                                        <option value="{{$field->id}}" {{$request_freelancer->main_field->title == $field->title ? 'selected' : ''}}>
                                            {{$field->title}}
                                            </option>
                                        @endforeach
                            ...
                            <div class="col-md-6 mb-25">
                                <div class="form-group select-px-15 text-end">
                                    ...
                                    <select class="form-control px-15 text-end" id="countryOption0909" name="sub_field_id" required>
                                        ...
                                        <option value="{{$field->id}}" {{$request_freelancer->sub_field->title == $field->title ? 'selected' : ''}}>{{$field->title}}</option>
                            ...
                            <div class="col-md-6 mb-25">
                                <div class="form-group select-px-15 text-end">
                                    ...
                                    <select class="form-control px-15 text-end" id="statusOption0909" name="freelancer_status" required>
                                            <option class="text-end" selected disabled>حالة المستقل  </option>

                                        <option value="موجود" {{$request_freelancer->freelancer_status == 'موجود' ? 'selected' : ''}}>موجود</option>
                                        <option value="مطلوب" {{$request_freelancer->freelancer_status == 'مطلوب' ? 'selected' : ''}}>مطلوب</option>
                            ...
                            <div class="col-md-6 mb-25">
                                <input type="text" name="desc" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="الوصف" value="{{value($request_freelancer->desc)}}">
                            </div>
