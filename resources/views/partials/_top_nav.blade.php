<nav class="navbar navbar-light">
    <div class="navbar-left">
        <div class="logo-area">
            <a class="navbar-brand" href="{{ route('dashboard.home',app()->getLocale()) }}">
                <img class="dark" src="{{ asset('assets/img/logo/3rdy.png') }}" alt="svg">
                <img class="dashboard-icon" width="100%" src="{{ asset('assets/img/logo/icon.png') }}" alt="svg">
            ...
            <div class="hexadash-top-menu position-relative">
                <ul>
                    <li class="has-subMenu">
                        ...
                        <ul class="subMenu">
                            <li><a class="{{ Request::is(app()->getLocale().'/dashboards/demo-one') ? 'active':'' }}" href="{{ route('dashboard.home',app()->getLocale()) }}">{{ trans('menu.dashboard-demo-one') }}</a></li>
                            ...
                            <ul>
                                <li>
                                    <a href="{{route('profile' , app()->getLocale())}}">
                                        <img src="{{ asset('assets/img/svg/user.svg') }}" alt="user" class="svg"> حسابي</a>
                                </li>
...
<script>
  ...
  if (window.innerWidth < 768) { // Adjust breakpoint as needed
    ...
    document.querySelector(".dashboard-icon").style.display = "block";
  } else {
    document.querySelector(".dark").style.display = "block";
    document.querySelector(".dashboard-icon").style.display = "none";
  }
}

window.addEventListener("resize", checkScreenSize);
checkScreenSize(); // Execute initially
