...
use App\Http\Controllers\dashboard\TransfersMethodsController;
...
Route::group(['middleware'=>'auth'],function(){
    Route::group(['prefix'=>'{language}'],function(){
        // المستقلين
            ...
            Route::get('add/transfers/methods' , [TransfersMethodsController::class , 'add_method'])->name('TransfersMethods.add');
            Route::get('all/transfers_methods' , [TransfersMethodsController::class , 'all_methods'])->name('TransfersMethods.all');
            Route::post('transfers_methods' , [TransfersMethodsController::class , 'store_method'])->name('TransfersMethods');
            Route::get('edit/transfers/methods/{id}' , [TransfersMethodsController::class , 'edit_method'])->name('TransfersMethods.edit');
            Route::post('update/transfers_methods/{id}',  [TransfersMethodsController::class , 'update_method'])->name('TransfersMethods.update');
            Route::get('delete/transfers_methods/{id}' , [TransfersMethodsController::class , 'delete_method'])->name('TransfersMethods.delete');
...
Route::get('add/keyword', [KeywordController::class, 'add_keyword'])->name('add_keywords');
Route::get('all/keywords', [KeywordController::class, 'all_keywords'])->name('all_keywords');
Route::post('keywords', [KeywordController::class, 'store_keyword'])->name('store_keywords');
Route::get('edit/keyword/{id}', [KeywordController::class, 'edit_keyword'])->name('edit_keywords');
Route::post('update/keyword/{id}', [KeywordController::class, 'update_keyword'])->name('update_keywords');
Route::get('delete/keyword/{id}', [KeywordController::class, 'delete_keyword'])->name('delete_keywords');
...
Route::get('order/update_status/{id}',[OrderController::class , 'update_status'])->name('update_order_status');
            ...
            Route::get('all/transfer/orders' , [TransferController::class , 'transfersOrders'])->name('all_transfer_orders');

Route::post('/transfers/{id}/toggle-status', [TransferController::class, 'toggleStatus'])->name('transfers.toggle_status');

Route::post('/transfers/bulk-update', [TransferController::class, 'bulkUpdate'])->name('transfers.bulk_update');
            ...
            Route::get('all/previous/client/{id}' , [MarketingController::class , 'getAllPreviousClients'])->name('all_previous_client');
              Route::get('all/previous/clientOrders/{id}' , [MarketingController::class , 'getClientsOrders'])->name('all_previous_client_orders');
        ...
        Route::get('freelancer-Orders-Detailes/{id}/{inverntory_id}',[FinalReportController::class ,'FreelancerOrderDetails'])->name('freelancer.orders.details');

        Route::get('Marketing-Detailes/{id}',[FinalReportController::class ,'marketingDetailsView'])->name('marketing.details');
        Route::get('Marketing-Order-Detailes/{id}/{inventory_id}',[FinalReportController::class ,'MarketingOrderDetails'])->name('marketing.order.details');

        Route::get('SalesAgent-Detailes/{id}',[FinalReportController::class ,'SalesAgentView'])->name('salesAgent.details');
        Route::get('SalesAgent-Order-Detailes/{id}/{inventory_id}',[FinalReportController::class ,'SalesAgentOrdersDetails'])->name('salesAgent.order.details');

        Route::get('SalesOfficer-Detailes/{id}',[FinalReportController::class ,'SalesOffierView'])->name('salesOfficer.details');
        Route::get('SalesOfficer-Order-Detailes/{id}/{inventory_id}',[FinalReportController::class ,'SalesOfficerOrdersDetails'])->name('salesOfficer.order.details');
